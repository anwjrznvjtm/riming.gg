// League of Legends Data Dragon Champion Mapping & Icon Helper
// DDragon version 14.1.1 or latest static CDN

export const CHAMPION_DDRAGON_MAP: Record<string, string> = {
  '가렌': 'Garen',
  '갈리오': 'Galio',
  '갱플랭크': 'Gangplank',
  '갱플': 'Gangplank',
